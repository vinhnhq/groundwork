...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        // rounded-lg (8px), NOT rounded-xl: the highlight must sit INSIDE the
        // content's inner corner (rounded-2xl 16px − p-1 4px = 12px). A child
        // radius equal to the inner radius bleeds the focus bg past the corner.
