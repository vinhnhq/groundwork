...
function SidebarMenuButton({
  ...
  const button = (
    <Comp
      ...
      data-size={size}
      // Omit when inactive: React renders a boolean as data-active="false"
      // (attribute present), and the variants match on presence (data-active:),
      // so emitting it always would light every item. Undefined drops it.
